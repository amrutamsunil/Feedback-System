...
if(isset($cse))
{
    $_SESSION['dept_id']=1; header('location:login.php');
}
elseif (isset($ece)){
    $_SESSION['dept_id']=2; header('location:login.php');
}
elseif (isset($mech)){
    $_SESSION['dept_id']=3; header('location:login.php');
}
elseif (isset($civil)){
    $_SESSION['dept_id']=4; header('location:login.php');
}
elseif (isset($eee)){
    $_SESSION['dept_id']=5; header('location:login.php');
}
elseif (isset($mba)){
    $_SESSION['dept_id']=6; header('location:login.php');
}
?>
<!DOCTYPE HTML>
<html>
